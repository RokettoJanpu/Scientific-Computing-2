...
\begin{center}
	\includegraphics[scale=.2]{hw11 sol at n = 10}
	\includegraphics[scale=.2]{hw11 sol at n = 20}
	\includegraphics[scale=.2]{hw11 sol at n = 40}
	\includegraphics[scale=.2]{hw11 sol at n = 80}
\end{center}
