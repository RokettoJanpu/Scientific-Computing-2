...
\tbf{Problem 1.} The file Lagaris5.ipynb was modified:

\url{https://github.com/RokettoJanpu/Scientific-Computing-2/blob/main/hw9 q1 v2.ipynb}

\begin{itemize}
	\item In the function ExactSolution, return $y^2\sin\pi x$.
	\item In the function ActiveFun(x),
\end{itemize}
...
\begin{center}
	\includegraphics[scale=.5]{hw9 q2 t=0}
	\includegraphics[scale=.5]{hw9 q2 t=2}
\end{center}
