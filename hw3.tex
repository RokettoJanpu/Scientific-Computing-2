...
= 1-2\inv
= \frac12$$
Thus the method is 2nd order accurate. To show it is A--stable, we first find the stability function $R(z)$ and let $|z|\to\infty$. 
...
To finish showing A--stability, we plot $|R(z)|<1$ and see that it contains the left half plane.
